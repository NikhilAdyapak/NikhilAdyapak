...
| :--- | :--- | :--- |
| **Sentinel-Edge AI** | **(MadData 26 Hackathon)** Selected for the **Qualcomm Track** (1 of 10 teams / 350+ registrants). Built an on-device AI security auditor for sensitive documents. | 📺 [**Video Demo**](https://www.youtube.com/watch?v=o6RKIUL6Ju0) <br> 🏆 [**Devpost**](https://devpost.com/software/sentinel-edge-ai-6f4zkc?ref_content=user-portfolio&ref_feature=in_progress) <br> 💻 [**View Repo**](https://github.com/NikhilAdyapak/SentinelAI) |
