...
| :--- | :--- | :--- |
| **Sentinel-Edge AI** | **(MadData 26 Hackathon)** Selected for the **Qualcomm Track** (1 of 10 teams / 350+ registrants). Built an on-device AI security auditor for sensitive documents. | 📺 [**Video Demo**](https://www.youtube.com/watch?v=o6RKIUL6Ju0) <br> 🏆 [**Devpost**](YOUR_DEVPOST_LINK_HERE) <br> 💻 [**View Repo**](YOUR_GITHUB_REPO_LINK_HERE) |
