...
| **MLOps Pipeline for Pedestrian Detection** | Built an end-to-end MLOps lifecycle using **DVC + MLflow** on Azure. Enabled multi-GPU training and reduced costs by 60%. | 💻 [**MLOps DVC Pipeline**](https://github.com/NikhilAdyapak/DVC_Detectron2) <br> 💻 [**MLOps Pedestrian Detection**](https://github.com/NikhilAdyapak/MLOps_Pipeline) <br> 💻 [**MLOps Repos**](https://github.com/Kora-Scenes)|
