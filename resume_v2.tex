...
\begin{center}
    \textbf{\Huge \scshape Nikhil Adyapak} \\ \vspace{2.5pt}
    ...
    \textbf{Seeking 2026 Summer Internship/Fall Co-op in ML, ML Systems, MLOps or Data Science}
\end{center}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubSubheading{\textbf{Machine Learning Operations (MLOps) Intern}}{Jan 2023 -- May 2023 $|$ Jun 2022 -- Jul 2022}
       \resumeItemListStart
        ...
        \resumeItem{Containerized models (\textbf{Docker}), built CI/CD using Azure DevOps automating deployment to Azure Container Registry.}
       \resumeItemListEnd
